...
<div id="top" class="container">
	...
	<div class="row">
		...
		<div class="col-md-offset-5 col-md-2 col-sm-3 col-xs-4" style="margin-top:20px"><a href="${pageContext.servletContext.contextPath}/agent/login"><button type="submit" class="btn button btn-link">Agent Login</button></a></div>
		<div class="col-md-2 col-sm-2 col-xs-4" style="margin-top:20px"><a href="signup"><button type="submit" class="btn button btn-link">User SignUp</button></a></div>			
	</div>
...
<div class="container" style="margin-top:160px;padding-top:60px">
  ...
  <h2 class="text-center" style="color:#398ea8">User Login</h2><br></div><br><br><br>
