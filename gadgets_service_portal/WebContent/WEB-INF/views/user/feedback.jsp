...
<div class="container" style="margin-top:160px; padding-top:50px;padding-bottom:20px">

	<form action="feedback" method="post">
	
	<div class="form-group">
      <label class="control-label col-sm-offset-3 col-sm-2" for="feedback">Feedback</label>
      <div class="col-sm-5">   
      <input type="text" class="form-control" placeholder="Give feedback" name="feedback">       
        <input type="hidden" name="reqId" value="${requestScope.reqID}"><br><br>
		<button type="submit" class="btn btn-default" style="background-color:#398ea8; color:#ffffff" >Update Feedback</button>
      </div>
    </div><br>
