...
<div class="container" style="margin-top:160px; padding-top:10px;padding-bottom:20px">
	<div class="container"">
  <h2 class="text-center" style="color:#398ea8">Edit Profile</h2>
  </div>
  <br>
  ...
  <form:form modelAttribute="agent" method="post" class="form-horizontal">
    <div class="form-group">
      ...
      <div class="col-sm-5">
      <form:input path="name" class="form-control" value="${sessionScope.agent.name}"/>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-5">
      <form:input path="email" class="form-control" value="${sessionScope.agent.email}"/>
